...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <form class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="search" placeholder="Search" style="hight: 15px;">
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><i class="fa-brands fa-searchengin"></i></button>
    </form>
  </div>
</nav></header>
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Manage subcategory<b></b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>New subcategory</span></a>
			...
			<table class="table table-striped table-hover">
				...
				if($result){
					while($row=mysqli_fetch_assoc($result)){
						...
						<a href="updatesub.php?id='.$subcategoryid.'"><i class="fa-solid fa-pen-to-square"></i></a>
						</td>
						<td>
